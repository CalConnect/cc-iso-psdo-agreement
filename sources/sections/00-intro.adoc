...
{collaboration-party} and CalConnect as
"`{collaboration-party}/CalConnect Standards`",
...
CalConnect and {collaboration-party} support a policy of inclusiveness and
encourages cooperation with other standardizing bodies,
in order to ensure effective and efficient use of resources
available for standardization activities.

=== Intention

{collaboration-party} and CalConnect agree to the principles of cooperation described in
this document, in all fields subject to approval by the governing bodies of
{collaboration-party} and CalConnect TC PUBLISH and TCC
